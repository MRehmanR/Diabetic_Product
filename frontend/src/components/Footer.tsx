...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-border/60 bg-muted/40">
      <div className="mx-auto grid max-w-[1600px] gap-10 px-4 py-12 sm:px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li className="flex items-center gap-2">
              <MessageCircle className="h-4 w-4 text-secondary" /> WhatsApp: {BUSINESS.phone}
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-primary" /> {BUSINESS.city}
            </li>
          </ul>
        </div>
      </div>
